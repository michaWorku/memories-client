...
} from '../../../features/edit/enditModeSlice'
import {
  clearCurrentMemoryActionCreator,
  setCurrentMemoryActionCreator,
} from '../../../features/memory/currentMemorySlice'
import {
  addMemoryToFavorites,
  deleteFromFavoritesActionCreator,
  removeFavoriteMemory,
} from '../../../features/favorites/favoritesSlice'
import { decrementMemoriesNumberActionCreator } from '../../../features/auth/authSlice'
import {
...
const Memory: FC<Props> = forwardRef(
  (
    ...
    const currentMemory = useAppSelector(
      (state) => state.currentMemory
    )
    const lastChangedMemory = useAppSelector(
      (state) => state.lastChangedMemory
    )
