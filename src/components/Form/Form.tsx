...
import { incrementMemoriesNumberActionCreator } from "../../features/auth/authSlice";
...
import { MemoryFormData } from "../../type";
...
const Form: FC = () => {
  ...
  const currentMemory = useAppSelector( (state) => state.currentMemory);
