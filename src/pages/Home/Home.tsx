...
import { getUserMemories } from "../../features/memory/memorySlice";
import { getFavoriteMemories } from "../../features/favorites/favoritesSlice";
import { getUserCategories } from "../../features/category/categorySlice";
...
import { setLimitActionCreator } from "../../features/limit/limitSlice";
...
import { setMemoriesLoadingActionCreator } from "../../features/memory/memoriesLoadingSlice";
import { setCurrentMemoryActionCreator } from "../../features/memory/currentMemorySlice";
...
const Home: FC = () => {
  ...
  const memoriesLoading = useAppSelector(
    (state) => state.memoriesLoading
  );
